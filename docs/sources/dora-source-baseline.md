...
| 项目 | 值 |
| --- | --- |
| 基线标识 | `DORA-SOURCES-2026-08-31-DRAFT` |
| 状态 | 待人工复核 |
| 获取日期 | 2026-08-31 |
| 司法辖区 | 欧盟、Malta |
| 工作语言 | English |
...
进入 Roadmap 第 3 步前仍需完成：

- 由仓库维护者逐项复核官方标识、标题、日期、来源分类和链接。
- 对 Malta Act XI of 2025、Cap. 376 和当前 Financial Institutions Rulebook 的 DORA 相关条款做精确定位。
