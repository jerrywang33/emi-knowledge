...
`v0.3` 已完成专题范围、测试边界和来源复核，正在建立 ICT 业务连续性、备份与恢复的 Topic 清单和条款覆盖矩阵。来源复核见 [`DORA-ICT-CONTINUITY-SOURCES-2026-09-07-R1`](docs/sources/dora-ict-business-continuity-source-review.md)。当前固定发布仍为 `v0.2.0`，建设中的内容不能作为固定发布使用。
